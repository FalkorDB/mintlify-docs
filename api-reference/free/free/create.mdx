...
Provisions a new Free instance in the requested cloud provider and region. The instance is created asynchronously; poll [Describe](/api-reference/free/free/describe) until `status` is `RUNNING`.
