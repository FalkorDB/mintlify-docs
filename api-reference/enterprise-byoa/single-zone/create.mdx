...
description: "Provision a new Enterprise BYOA Single-Zone instance."
---

Provisions a new Enterprise BYOA Single-Zone instance in the requested cloud provider and region. The instance is created asynchronously; poll [Describe](/api-reference/enterprise-byoa/single-zone/describe) until `status` is `RUNNING`.
