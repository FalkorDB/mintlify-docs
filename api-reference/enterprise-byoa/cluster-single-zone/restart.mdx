...
api: "POST https://api.omnistrate.cloud/2022-09-01-00/resource-instance/sp-JvkxkPhinN/falkordb/v1/prod/falkordb-enterprise-byoa-byoa/falkordb-enterprise-byoa-falkordb-byoa-model-omnistrate-dedicated-tenancy/cluster-Single-Zone/{id}/restart"
description: "Restart an Enterprise BYOA Cluster (Single-Zone) instance."
---
