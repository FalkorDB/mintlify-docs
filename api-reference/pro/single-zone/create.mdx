...
sidebarTitle: "Create"
api: "POST https://api.omnistrate.cloud/2022-09-01-00/resource-instance/sp-JvkxkPhinN/falkordb/v1/prod/falkordb-pro-customer-hosted/falkordb-pro-falkordb-customer-hosted-model-omnistrate-dedicated-tenancy/single-Zone"
description: "Provision a new Pro Single-Zone instance."
---

Provisions a new Pro Single-Zone instance in the requested cloud provider and region. The instance is created asynchronously; poll [Describe](/api-reference/pro/single-zone/describe) until `status` is `RUNNING`.
