...
sidebarTitle: "Start"
api: "POST https://api.omnistrate.cloud/2022-09-01-00/resource-instance/sp-JvkxkPhinN/falkordb/v1/prod/falkordb-pro-customer-hosted/falkordb-pro-falkordb-customer-hosted-model-omnistrate-dedicated-tenancy/single-Zone/{id}/start"
description: "Start a stopped Pro Single-Zone instance."
---
