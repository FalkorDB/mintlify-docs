...
Provisions a new Startup Standalone instance in the requested cloud provider and region. The instance is created asynchronously; poll [Describe](/api-reference/startup/standalone/describe) until `status` is `RUNNING`.
...
<ParamField body="requestParams" type="object" required>
  ...
  <Expandable title="requestParams properties">
    ...
    <ParamField body="memoryRequestsAndLimits" type="string" default="1GB">
      Memory requested for and allocated to the database.
    </ParamField>
