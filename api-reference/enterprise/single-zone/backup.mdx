...
sidebarTitle: "Backup"
api: "POST https://api.omnistrate.cloud/2022-09-01-00/resource-instance/sp-JvkxkPhinN/falkordb/v1/prod/falkordb-enterprise-customer-hosted/falkordb-enterprise-falkordb-customer-hosted-model-omnistrate-dedicated-tenancy/single-Zone/{id}/backup"
description: "Trigger an on-demand backup of an Enterprise Single-Zone instance."
---
