...
description: "Provision a new Enterprise Standalone instance."
---

Provisions a new Enterprise Standalone instance in the requested cloud provider and region. The instance is created asynchronously; poll [Describe](/api-reference/enterprise/standalone/describe) until `status` is `RUNNING`.
