...
sidebarTitle: "Create"
api: "POST https://api.omnistrate.cloud/2022-09-01-00/resource-instance/sp-JvkxkPhinN/falkordb/v1/prod/falkordb-enterprise-customer-hosted/falkordb-enterprise-falkordb-customer-hosted-model-omnistrate-dedicated-tenancy/cluster-Multi-Zone"
description: "Provision a new Enterprise Cluster (Multi-Zone) instance."
---

Provisions a new Enterprise Cluster (Multi-Zone) instance in the requested cloud provider and region. The instance is created asynchronously; poll [Describe](/api-reference/enterprise/cluster-multi-zone/describe) until `status` is `RUNNING`.
