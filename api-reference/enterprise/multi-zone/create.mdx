...
sidebarTitle: "Create"
api: "POST https://api.omnistrate.cloud/2022-09-01-00/resource-instance/sp-JvkxkPhinN/falkordb/v1/prod/falkordb-enterprise-customer-hosted/falkordb-enterprise-falkordb-customer-hosted-model-omnistrate-dedicated-tenancy/multi-Zone"
description: "Provision a new Enterprise Multi-Zone instance."
---

Provisions a new Enterprise Multi-Zone instance in the requested cloud provider and region. The instance is created asynchronously; poll [Describe](/api-reference/enterprise/multi-zone/describe) until `status` is `RUNNING`.
