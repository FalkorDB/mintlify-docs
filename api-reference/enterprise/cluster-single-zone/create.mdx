...
sidebarTitle: "Create"
api: "POST https://api.omnistrate.cloud/2022-09-01-00/resource-instance/sp-JvkxkPhinN/falkordb/v1/prod/falkordb-enterprise-customer-hosted/falkordb-enterprise-falkordb-customer-hosted-model-omnistrate-dedicated-tenancy/cluster-Single-Zone"
description: "Provision a new Enterprise Cluster (Single-Zone) instance."
---

Provisions a new Enterprise Cluster (Single-Zone) instance in the requested cloud provider and region. The instance is created asynchronously; poll [Describe](/api-reference/enterprise/cluster-single-zone/describe) until `status` is `RUNNING`.
